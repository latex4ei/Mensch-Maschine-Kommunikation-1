...
\fancyhf{}
   ...
   \fancyfoot[C]{von Fabian Göttel und Hendrik Böttcher}
...
\begin{multicols*}{4}
	...
	\parbox{4cm}{
		\emph{\Large{Mensch-Maschine-Kommunikation 1}}
	}
...
\sectionbox{
	...
	\topicbox{Arten der Farbmischung}{
...
\sectionbox{
\subsubsection{CIE}
\parbox{3.5cm}{\includegraphics[width=3.5cm]{../img/CIE-Normfarbtafel.png}}
...
\cooknumbox{Regeln zur Umformung in Normalform:}{
%\begin{enumerate}
...
\cooknumbox{Tautologie beweisen: }{
...
\cooknumbox{Rückwärtsverkettung}{ 
...
\emphbox{$A \rightarrow BC$ oder $A \rightarrow a$}
}
...
\topicbox{HMM - Eigenschaften}{
\emph{Ergodisches HMM}
Es kann aus jedem Zustand in jeder andere Zustand erreicht werden; A ist voll besetzt\\
\emph{Links-Rechts-HMM}
keine Rücksprünge; kausal; A hat rechte obere Dreiecksform; Graphisch nach rechts aufsteigend $\Ra$ Name
}
}
...
\cooknumbox{Vorwärts-Algorithmus (Rekursiv)}{
...
\cooknumbox{Baum-Welch-Algorithmus (Rekursiv)}{
	\item Initialisierung\\
...
\cooknumbox{Viterbi-Algorithmus}{
	\item Initialisierung: \\
