...
% SECTION 2: SPRACHKOMMUNKIKATION ======================================
...
\begin{sectionbox}
	...
	\paragraph{Beispiel für einen deterministischen Zustandsautomaten}\ \\
	\parbox{0.5\textwidth}{
		\begin{equation*}
			\begin{aligned}
	...
	\paragraph{Beispiel für einen nicht-deterministischen Zustandsautomaten}\ \\
...
\begin{sectionbox}
	...
	\paragraph{Beispiel für einen Kellerautomaten:}\ \\
	\parbox{0.5\textwidth}{
		\begin{equation*}
		\begin{aligned}
			\mathcal S &= \{S_0,S_1\}\\
...
\begin{sectionbox}
	...
	Mathematische Formel zur Berechnun der Beobachtungswkt.\\ 
